...
//
//    public static Specification<Bid> bidsByUsername(String username, List<SearchCriteria> searchCriteriaList) {
//        return (root, query, criteriaBuilder) -> {
//            List<Predicate> predicates = new ArrayList<>();
//
//            // Subquery to match bids by username via consumerParticipantId
